...
<head>
    ...
    <title>Create your account | {{ $siteName }}</title>

    <meta name="description" content="Create your {{ $siteName }} account and start learning Chinese in Bangla today.">
            ...
            <div class="relative flex flex-col justify-between gap-16 px-12 py-14 xl:px-16">
                ...
                <div>
                    <h1 class="max-w-md text-4xl font-extrabold leading-tight font-display xl:text-5xl">
                        Welcome to <span class="text-emerald-400">Banglay Chinese</span>
                    </h1>
                    <p class="mt-4 max-w-md text-lg text-emerald-100/80">
                        Start learning Chinese in Bangla — live classes, HSK prep and study-in-China mentorship.
                    </p>
                ...
                <div class="rounded-2xl bg-white p-8 shadow-xl sm:p-10">
                    ...
                    @if (Route::has('login'))
                        <p class="mt-2 text-sm text-slate-500">
                            ...
                            <a href="{{ route('login') }}" class="font-semibold text-emerald-700 transition-colors hover:text-emerald-800">Sign in</a>
                        </p>
                    @endif
                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="phone" type="tel" name="phone" value="{{ old('phone') }}"
                                       autocomplete="tel" placeholder="+880 1XXX-XXXXXX"
                                       class="w-full rounded-lg border border-gray-300 bg-white py-3 pl-11 pr-4 text-gray-900 placeholder-gray-400 transition-colors focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500">
                            </div>
                            <p class="mt-1.5 text-xs text-slate-400">Used for class reminders and WhatsApp updates.</p>
                        </div>
                        ...
                        @if (Route::has('pages.show'))
                            <p class="text-center text-xs leading-relaxed text-slate-400">
                                ...
                                <a href="{{ route('pages.show', 'terms-and-conditions') }}" class="font-semibold text-emerald-700 transition-colors hover:text-emerald-800">Terms of Service</a>
                                and
                                <a href="{{ route('pages.show', 'privacy-policy') }}" class="font-semibold text-emerald-700 transition-colors hover:text-emerald-800">Privacy Policy</a>.
                            </p>
                        @endif
                    </form>
                </div>
